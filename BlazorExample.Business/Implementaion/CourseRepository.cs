using AutoMapper;
using BlazorExample.Business.Contracts;
...
namespace BlazorExample.Business.Implementaion
{
    public class CourseRepository : ICourseRepository
    {
        private readonly BlazorExampleContext _ctx;
        private readonly IMapper _mapper;

        public CourseRepository(BlazorExampleContext ctx, IMapper mapper)
        {
            _ctx = ctx;
            _mapper = mapper;
        }
